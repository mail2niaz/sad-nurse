...
public function getaidoperatorlist($aid)
{
		$oid = array();
		$this -> db -> select('pry_oid,sec_oid,sup_id');
		$this -> db -> from('assign_job_list');
