		...
		<div class="rightpanel">
			...
			<div class="pageheader">
				<p class="stdformbutton searchbar" style="text-align:right">
					<?php  $attributes2 = array('class' => 'btn btn-rounded btn-primary btn-submit');  echo anchor($i18n.'contract','<i class="icon-backward"></i>&nbsp;&nbsp;'.lang("ADMIN-SESSION-SETUP::session_list").'&nbsp;&nbsp;<i class="icon-forward"></i>',$attributes2); ?>
				</p>
				 <?php
				...
				<div class="maincontentinner">
					<div class="widgetbox box-inverse span10" style="margin-left: 5px;">
						...
						<div class="widgetcontent nopadding">
							...
							echo form_open($i18n.'admin_session_setup/add_admin_session_setup',$attributes);
