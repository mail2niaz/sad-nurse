...
<div id="mainwrapper" class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <div class="pagetitle">
               <h1><?php echo lang("REPORT::opt_report"); ?></h1>
            </div>
        </div><!--pageheader-->
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <h4 class="widgettitle"><?php echo lang("REPORT::opt_report"); ?></h4>
           ...
           echo form_open('patient/addpatient',$attributes); ?>
                           <p>
                                <label><?php echo lang("REPORT::role"); ?><span class="rstar">*</span></label>
