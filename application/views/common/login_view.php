...
<link rel="stylesheet" href="<?php echo base_url()?>css/style.shinyblue.css" type="text/css" />
<link rel="stylesheet" href="<?php echo base_url()?>css/style_custom.css" type="text/css" />
          ...
          <?php if(validation_errors()){ ?> <div class="alert alert-error"><?php echo validation_errors(); ?></div> <?php } ?>
           ...
           echo form_open('verifylogin',$attributes); ?>
            ...
            <div class="inputwrapper animate4 bounceIn">
                <div class="pull-right"><a href="#"><?php echo lang($forget_password); ?></a></div>
...
<div class="loginfooter">
    <p>&copy; 2013. Sad Nurse. All Rights Reserved.</p>
</div>
