...
*/
   ...
   echo json_encode($result);
    ...
    public function getIospatdetails(){
...
public function getfieldsdata(){
    ...
    public function getIosfieldsdata(){

        $ary = json_decode(file_get_contents('php://input'));
        $ary =  (array)$ary;
        $this->load->model('ws');
        $result = array();
        $result = $this->ws->putgetfieldsdata($ary);
...
public function mgeo_location()
{
      ...
      $result = $this->ws->geo_location_insert($oid,$aid,$type,$latitude,$longitude);
      json_encode($result);
