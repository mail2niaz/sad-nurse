...
<?php $contract_tags = array();
        ...
        foreach($query->result() as $row){
			...
			if($primary_roles != ""){
				...
				<div class="jobautocomp">
                              <label><?php echo ( sprintf( lang("JOBASSIGN::P2000_CODE_OP1")) ); ?></label>
                               <span class="field">
                              <input type="text" name="p200_code_op1" id="p200_code_op1" value="<?=$p200_code_op1?>" />
                        </div>
...
<?php
				...
				<div class="jobautocomp">
                              <label><?php echo ( sprintf( lang("JOBASSIGN::P2000_CODE_OP2")) ); ?><span class="rstar">*</span></label>
                               <span class="field">
                              <input type="text" name="p200_code_op2" id="p200_code_op2" value="<?=$p200_code_op2?>" />
                        </div>
...
<?php
				...
				<div class="jobautocomp">
                              <label><?php echo ( sprintf( lang("JOBASSIGN::P2000_CODE_OP3")) ); ?><span class="rstar">*</span></label>
                               <span class="field">
                              <input type="text" name="p200_code_op3" id="p200_code_op3" value="<?=$p200_code_op3?>" />
                        </div>
...
-				success: function(data) {
-					if(data) {
-						 alert('impossibile inserire l intervento. L utente è già impegnato per quella data a quell ora - Verificare.');         
-						event.preventDefault();
-						flag = 0;
-						
-					}
